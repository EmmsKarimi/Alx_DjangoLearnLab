...
SECRET_KEY = 'django-insecure-^8n@vs##_rw95byz17%d_-o2ld(=mt1_^a^+^+6+p++%hyo!6q'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Keep session auth for admin users
    ],
